...
//           className={`fixed ${side}-0 top-0 bottom-0 w-64 bg-gray-800 border-${
//             side === "left" ? "r" : "l"
...
//     <ul className="mb-8">
//       {["React Enthusiasts", "Python Developers", "DevOps Unite"].map(
//         (group, index) => (
...
//     </h2>
//     <ul>
//       {["Hackathon 2024", "Web3 Meetup", "AI in Software Dev"].map(
//         (event, index) => (
...
//             isLiked ? "text-blue-400" : "hover:text-blue-400"
//           }`}
//           onClick={handleLike}
//         >
...
//                   <span className="text-xs">Live Code</span>
//                 </motion.button>
//               </div>
//               <motion.button
//                 whileHover={{ scale: 1.05 }}
